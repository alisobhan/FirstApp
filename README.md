...
To update the database use this command from the Web project folder (replace `FirstApp` with your project's name):

```powershell
dotnet ef database update -c AppDbContext -p ../FirstApp.Infrastructure/FirstApp.Infrastructure.csproj -s FirstApp.Web.csproj
```
